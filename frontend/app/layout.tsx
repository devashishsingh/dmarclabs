    ...
    <html lang="en" className="dark">
      <body>
        ...
        <a
          ...
          className="fixed bottom-6 right-6 z-50 flex items-center gap-2.5 rounded-full bg-[#25D366] px-4 py-3 text-white text-sm font-medium shadow-lg shadow-black/40 hover:bg-[#1ebe5d] hover:scale-105 active:scale-95 transition-all duration-150 group"
        >
          {/* WhatsApp icon */}
